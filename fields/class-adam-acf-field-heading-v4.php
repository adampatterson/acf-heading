...
class adam_acf_field_heading extends acf_field {
	...
	*/
	...
	function __construct( $settings )
	{
		...
		$this->category = __("Basic",'adam'); // Basic, Content, Choice, etc
		$this->defaults = array(
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		<label><?php _e("Preview Size",'adam'); ?></label>
		<p class="description"><?php _e("Thumbnail is advised",'adam'); ?></p>
	</td>
	<td>
		<?php
		...
		do_action('acf/create_field', array(
			...
			'layout'	=>	'horizontal',
			'choices'	=>	array(
				'thumbnail' => __('Thumbnail', 'adam'),
				'something_else' => __('Something Else', 'adam'),
			)
		));
